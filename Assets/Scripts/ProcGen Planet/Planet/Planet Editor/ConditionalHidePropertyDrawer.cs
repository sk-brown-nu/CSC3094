...
{
    /// <summary>
    /// Custom property drawer for the <see cref="ConditionalHideAttribute"/>
    /// Used in <see cref="PlanetEditor"/>.
    /// </summary>
    /// <remarks>
    /// Original version of the ConditionalPropertyDrawer created by Brecht Lecluyse (www.brechtos.com).
