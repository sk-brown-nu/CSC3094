...
namespace ProcGenPlanet
{
    ...
    {
        /// <summary>
        /// A static, blittable version of <see cref="OpenSimplex"/> for optimised use in Unity jobs and burst.
        /// </summary>
        public static class StaticOpenSimplex
        {
            #region Values
            ...
            {
                var random = new NativeArray<int>(RandomSize * 2, Allocator.Temp);
                ...
                if (seed != 0)
                {
                    ...
                    // with each byte
                    var F = new NativeArray<byte>(4, Allocator.Temp);
            ...
            static double Dot(int3 g, double x, double y, double z, double t)
            {
            ...
            static double Dot(int3 g, double x, double y)
            {
                return g[0] * x + g[1] * y;
            }
            ...
            static NativeArray<byte> UnpackLittleUint32(int value, ref NativeArray<byte> buffer)
            {
                if (buffer.Length < 4)
                    buffer = new NativeArray<byte>(4, Allocator.Temp);
            ...
            /// cube)
            /// </summary>
            public static NativeArray<int3> GetGrad3()
            {
                NativeArray<int3> grad3 = new(12, Allocator.Temp);
                grad3[0] = new int3(1, 1, 0);
                grad3[1] = new int3(-1, 1, 0);
                grad3[2] = new int3(1, -1, 0);
                grad3[3] = new int3(-1, -1, 0);
                grad3[4] = new int3(1, 0, 1);
                grad3[5] = new int3(-1, 0, 1);
                grad3[6] = new int3(1, 0, -1);
                grad3[7] = new int3(-1, 0, -1);
                grad3[8] = new int3(0, 1, 1);
                grad3[9] = new int3(0, -1, 1);
                grad3[10] = new int3(0, 1, -1);
                grad3[11] = new int3(0, -1, -1);
                return grad3;
            }
        }
    }
